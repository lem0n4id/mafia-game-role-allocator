# Mafia Game Role Allocator — Detailed Development Guide

> **Note**: This is the detailed companion guide to `.github/copilot-instructions.md`. 
> For quick onboarding and essential information, see the main instructions file first.

## Table of Contents
- [Documentation Update Protocol](#documentation-update-protocol)
- [Code Organization Principles](#code-organization-principles)
- [Component Patterns](#component-patterns)
- [Development Workflow](#development-workflow)
- [Architecture Status & Decisions](#architecture-status--decisions)
...
✅ **1. UPDATE copilot-instructions.md:**
   - [ ] Update "Current Architecture Status" section if architecture changed

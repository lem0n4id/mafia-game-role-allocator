    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        {validation.errors.count && (
          <p id="count-error" className="mt-1 text-sm text-red-600" role="alert">
            {validation.errors.count}
          </p>
        )}
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-sm text-gray-600">
            {names.filter(name => name.trim()).length} of {playerCount} completed
          </div>
        </div>
        ...
        {validation.errors.names && (
          <p id="names-error" className="mt-2 text-sm text-red-600" role="alert">
            {validation.errors.names}
          </p>
        )}
      </div>
